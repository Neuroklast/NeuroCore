...
Gate 2026-08-21: **0.5.0-alpha**. Sanitation-Kette nach DSL. DSP-Runtime: Tape → optional asmjit (Win x64 Arithmetik) → `processBlock`-Dispatch → 64-align Ringe → Plugin-LTO. macOS: VST3+AU, Tape, WKWebView. Artefakte: `build/NeuroKore_artefacts/Release/Standalone/NEUROKORE-0.5.0-alpha.exe`, `build/NeuroKore_artefacts/Release/VST3/NEUROKORE-0.5.0-alpha.vst3` (Mac: plus `.component`).
