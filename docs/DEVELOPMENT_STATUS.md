...
| WP5 Assemble | **grün** — React Flow: easy-connect, proximity, pulse-edges, context menu, zoom-tiers, validation, L→R. ChipSpec catalog (`chipSpec` / `typeCode` / `minBodyPx`); expand no longer grows the chip. |
