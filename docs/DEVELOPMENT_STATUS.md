...
| WP2 WebView-Shell | **grün** — `tests/WebShellTest.h`. Web only. Processor owns the browser (`WebViewHolder`); editor close hides/reparents it (removeChild, no delete). Reopen is 0 ms — zip index and JS heap stay. |
