...
English UI. Formats: **Standalone**, **VST3**, and on Mac an **Audio Unit**. Version **0.6.0-beta**.
...
Windows
1. Run `NEUROKORE-0.6.0-beta-Setup.exe` as administrator. Pick VST3 and/or Standalone (English or German).
...
Windows: `build_release.bat`. Mac also builds the AU. Artefacts: `build/NeuroKore_artefacts/Release/` (`NEUROKORE-0.6.0-beta.exe` / `.vst3` / `.component`).
