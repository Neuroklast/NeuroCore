...
#define MyAppExeName "NEUROKORE-0.5.1-alpha.exe"
...
Source: "{#NcStage}\NEUROKORE-0.5.1-alpha.vst3\*"; DestDir: "{commoncf64}\VST3\NEUROKORE-0.5.1-alpha.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
