...
#define MyAppVersion "0.4.7-alpha"
#define MyAppPublisher "Neuroklast"
#define MyAppURL "https://neuroklast.net"
#define MyAppExeName "NEUROKORE-0.4.7-alpha.exe"
...
Source: "{#NcStage}\NEUROKORE-0.4.7-alpha.vst3\*"; DestDir: "{commoncf64}\VST3\NEUROKORE-0.4.7-alpha.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
