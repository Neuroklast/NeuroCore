...
#define MyAppVersion "0.4.10-alpha"
#define MyAppPublisher "Neuroklast"
#define MyAppURL "https://neuroklast.net"
#define MyAppExeName "NEUROKORE-0.4.10-alpha.exe"
...
Source: "{#NcStage}\NEUROKORE-0.4.10-alpha.vst3\*"; DestDir: "{commoncf64}\VST3\NEUROKORE-0.4.10-alpha.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
