...
#define MyAppExeName "NEUROKORE-0.5.0-alpha.exe"
...
Source: "{#NcStage}\NEUROKORE-0.5.0-alpha.vst3\*"; DestDir: "{commoncf64}\VST3\NEUROKORE-0.5.0-alpha.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
