...
#define MyAppExeName "NEUROKORE-0.4.8-alpha.exe"
...
Source: "{#NcStage}\NEUROKORE-0.4.8-alpha.vst3\*"; DestDir: "{commoncf64}\VST3\NEUROKORE-0.4.8-alpha.vst3"; Flags: ignoreversion recursesubdirs createallsubdirs
